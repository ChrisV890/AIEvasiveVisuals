#-------------------------
#Deprecated now, original Idea of trying to create a patch myself, went with an active library that had built in training on data and model which helped in the long term. Please Refer to CNNM.py, ResNetM.py, and attackUtility.py
#--------------------------
